...
The assembled full script is on a separate, password-protected page:

[:lock: Open the full solution](capstone-solution.md){ .md-button }

Ask your lecturer for the password during the workshop. Try the staged hints above first — you'll learn more from getting stuck and unstuck than from copying the finished script.
