# cadwork 3d Python API

The cadwork 3d Python API allows you to automate and extend cadwork 3d using Python scripts. This section covers how to get started and work with elements programmatically.
...
Hands-on exercises using a timber framed slab model, progressing from reading to creating:
